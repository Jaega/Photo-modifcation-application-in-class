...
public class ImageEditor {
	public static void main(String[] args) throws IOException {
		Picture f = PictureImpl.readFromURL("https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Village_weaver_%28Ploceus_cucullatus_cucullatus%29_female.jpg/532px-Village_weaver_%28Ploceus_cucullatus_cucullatus%29_female.jpg");
